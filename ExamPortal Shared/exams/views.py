...
def exam_view(request, exam_id):
    ...
    if attempt is None:
        ...
        print(
            f"ExamAttempt created: "
            f"{attempt.student.username} - "
            f"{attempt.exam.title}"
        )
...
def exam_violation(request, exam_id):
    ...
    if attempt.violation_count == 0:
        ...
        return render(
            ...
            "violation.html",
            {
                ...
                "message": (
                    "You have left the examination "
                    "window. This is your first warning. "
    ...
    elif attempt.violation_count == 1:
